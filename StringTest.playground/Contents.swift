...
//Closures
var originalString = "shilpa"

var reversedString : (String) -> String = { word in
    var reversedWord = ""
...
print(reversedString(originalString))
...
print(strings.map { hashtags(in: $0) }) // array of arrays
print(strings.flatMap { hashtags(in: $0) }) //array
